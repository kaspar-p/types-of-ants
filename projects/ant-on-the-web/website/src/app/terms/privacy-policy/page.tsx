...
export default function PrivacyPolicyPage() {
  return (
    <div className="h-full flex flex-col items-center justify-center">
      <TermSection>
        <TermSectionTitle>privacy policy</TermSectionTitle>
        <p>Last Updated: 2025-08-03</p>
        <p>
          typesofants.org operates this store and website, including all related
      ...
      <TermSection>
        <TermSectionTitle>Personal Information Sources</TermSectionTitle>
        <p>
          ...
          personal information; Automatically through the Services including
          from your device when you use our products or services or visit our
          ...
          information on our behalf; From our partners or other third parties.
        </p>
      </TermSection>
      <TermSection>
        <TermSectionTitle>
      ...
      <TermSection>
        <TermSectionTitle>Children&apos;s Data</TermSectionTitle>
        <p>
      ...
      <TermSection>
        <TermSectionTitle>Your Rights and Choices</TermSectionTitle>
        <p>
      ...
      <TermSection>
        <TermSectionTitle>Complaints</TermSectionTitle>
        <p>
      ...
      <TermSection>
        <TermSectionTitle>International Transfers</TermSectionTitle>
        <p>
