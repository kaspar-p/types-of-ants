...
update migration
set created_at = '2023-06-20 00:00:00'::timestamp with time zone
where migration_label = 'Add phone number to the registered_user table'
;

update migration
set created_at = '2023-08-08 00:00:00'::timestamp with time zone
where migration_label = 'New ant release, 08-08-2023'
;

update migration
set created_at = '2024-02-03 00:00:00'::timestamp with time zone
where migration_label = 'New ant release, 02-03-2024'
;

update migration
set created_at = '2024-04-14 00:00:00'::timestamp with time zone
where migration_label = 'New ant release, 04-14-2024'
;

update migration
set created_at = '2024-05-05 00:00:00'::timestamp with time zone
...
update migration
set created_at = '2024-07-22 00:00:00'::timestamp with time zone
...
update migration
set created_at = '2024-09-08 00:00:00'::timestamp with time zone
where migration_label = 'ant-release:2024.9.8'
;

update migration
set created_at = '2025-02-17 00:00:00'::timestamp with time zone
